...
import WorkPopup from "components/molecules/workExperiencePopup";
        ...
        <div className="md:flex justify-between">
          <div>
            ...
            <ul className="p-4 list-disc text-m-regular font-cairo text-neutral-1000">
              <li>
                Merancang dan memberikan antarmuka pengguna untuk aplikasi
                seluler dan web, termasuk wireframe, mockup, dan prototipe.
              </li>
              <li>
                Melakukan penelitian pengguna dan pengujian ketergunaan untuk
                mengidentifikasi kebutuhan dan masalah pengguna, dan memasukkan
                umpan balik ke dalam desain.
              </li>
            </ul>
          </div>
          <div className="flex mt-2 gap-3 self-start">
            <div
              onClick={handleCardOpen}
              className="flex cursor-pointer items-center text-primaryBlue-main gap-1"
            >
              {<Pencil size={12} />}
