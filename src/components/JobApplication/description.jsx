  ...
  return (
    <div className="bg-white p-5 h-fitt w-full flex flex-col gap-5">
      ...
      <div className="font-rajdhani flex flex-col gap-5 text-md">
        ...
        cum! Culpa quas tenetur vero incidunt eaque, sit accusamus id hic,
        voluptatum consequuntur reiciendis quo quam ipsa deserunt suscipit.
        Ipsam fugiat totam molestiae, itaque dolores magni repellat veniam
        dolor? Iusto, culpa fugit. Incidunt explicabo odit ea beatae, in nemo
        nostrum?
      </div>
