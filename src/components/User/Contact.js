        ...
        <div>
            <div>
                ...
                <form className="flex mt-2 flex-col gap-4">
                    ...
                    <div className="flex flex-col">
                        <label className="font-cairo  self-start cairo-xl-regular">Alamat Email</label>
                        <input type="text" className="py-2 px-4 outline-primaryBlue-main outline-2 rounded-md  outline focus:outline-primaryBlue-main focus:ring-1 focus:ring-primaryBlue-main"  />
                    </div>
                    <div className="flex flex-col">
                        <label className="font-cairo  self-start cairo-xl-regular">Negara</label>
                        <input type="text" className="py-2 px-4 outline-primaryBlue-main outline-2 rounded-md outline focus:outline-primaryBlue-main focus:ring-1 focus:ring-primaryBlue-main"  />
                    </div>
                    <div className="flex flex-col">
                        <label className="font-cairo self-start cairo-xl-regular">Kota</label>
                        <input type="text" className="py-2 px-4 outline-primaryBlue-main outline-2 rounded-md outline focus:outline-primaryBlue-main focus:ring-1 focus:ring-primaryBlue-main"  />
                    </div>
                    <div className="flex flex-col">
                        <label className="font-cairo self-start cairo-xl-regular">Alamat</label>
