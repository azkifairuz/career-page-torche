            ...
            <div>
                ...
                <form>
                    <div className="flex flex-col">
                        <label className="font-cairo  cairo-xl-regular">Phone</label>
                    ...
                    <div className="flex flex-col">
                        ...
                        <textarea type="text" className="py-2 px-4 outline-primaryBlue-main outline-2 rounded-md outline focus:outline-primaryBlue-main focus:ring-1 focus:ring-primaryBlue-main"  ></textarea>
                    </div>
                </form>
            </div>
        </div>
