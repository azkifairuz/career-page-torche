...
export default function ResumePopup(props) {
    ...
    return(
        ...
        <section className="px-[32px]  py-[16px] flex flex-col gap-[16px]">
            ...
            <p className="text-m-regular w-full text-neutral-800">We prefer resumes to be in PDF format and no larger than 5MB. Don't worry, we won't share your info with anyone except the companies you're applying to.</p>
        </section>
