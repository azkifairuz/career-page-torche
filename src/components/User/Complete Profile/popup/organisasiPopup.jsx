  ...
  return (
    <form className="rounded-lg z-50 w-[350px] md:w-[537px] bg-white">
      <div className="p-[16px_32px_16px_32px] border-b border-neutral-400 flex items-center justify-between">
        <h1 className="heading-s-bold">Organisasi</h1>
        <X
          size={30}
          color="#727272"
      ...
      <div className="px-[32px]  py-[16px] flex flex-col gap-[16px]">
        <section>
          <p className="text-xl-regular">Nama Organisasi</p>
          <input
            type="text"
        ...
        <section className="flex gap-2">
          <input
            type="checkbox"
            className="h-6 w-6 rounded-[4px] border focus:outline-none focus:border-primaryBlue-main border-neutral-500"
          />
          <p className="text-l-regular">
            Saat ini saya masih beresekolah di sini
          </p>
        </section>
        <section>
