...
export default function HeaderSection() {
  ...
  return (
    <div
      className={`px-6 pt-2 lg:h-fit   md:p-8 md:pb-16 box-border lg:justify-between h-[650px] md:h-fit lg:px-24 lg:py-10 lg:flex bg-[url('assets/images/hero.png')] bg-no-repeat bg-cover text-white`}
    >
      <div className="flex flex-col md:flex-row md:gap-6">
        ...
        <div className="lg:w-[417px] md:w-full">
          <div>
            <h1 className="font-rajdhani text-center  capitalize heading-l-bold text-white md:text-start">
              John Kebab
            </h1>
            <p className="font-rajdhani heading-s-medium   text-center capitalize text-white md:text-start">
              Web Developer
            </p>
          </div>
      ...
      <div className="lg:w-[397px] relative md:static w-full">
