  ...
  return (
    <div className=" w-full flex flex-col gap-4 shadow-card rounded-lg p-6">
      <div
        ...
        className={` ${
          !isCardOpen && "hidden"
        } p-5 fixed flex inset-0 overflow-scroll justify-center items-center  z-50 bg-opacity-50 w-full   bg-black`}
      >
        <div
      ...
      <div>
        <h1 className="text-m-regular font-cairo text-neutral-1000">
          Saya merupakan lulusan S1 Pendidikan Bahasa Inggris dengan pengalaman
          kerja di bidang penulisan kreatif dan copywriter kurang lebih dua
          tahun.
        </h1>
      </div>
    </div>
