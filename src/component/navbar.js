...
function Navbar() {
    return(
        <>
            <nav className="sticky box-border justify-evenly left-0 right-0 px-4 bg-blue-500 top-0  flex">
                <div className="w-1/2">
                    <img className="w-32" src={Logo}alt="Torche"></img>
                </div>
                <ul className="flex my-auto gap-4 text-white ">
                    <li className=" items-center py-navbar-item px-navbar-item hover:bg-blue-700">
                        <Link to ="/">Home</Link>
                    </li>
                    <li className=" items-center py-navbar-item px-navbar-item hover:bg-blue-700">
