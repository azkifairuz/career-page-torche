...
function Navbar() {
    return(
        <>
            <nav className="fixed box-border justify-evenly left-0 right-0 px-4 bg-blue-900 top-0  flex">
                <div className="w-1/2">
                ...
                <ul className="flex my-auto gap-4 text-white ">
                    <li className=" items-center  py-navbar-item rounded-md hover:bg-blue-700">
                        <Link  className=" py-navbar-item px-navbar-item items-center" to ="/home">Home</Link>
                    </li>
                    <li className=" items-center py-navbar-item rounded-md hover:bg-blue-700">
