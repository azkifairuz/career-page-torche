  ...
  return (
    <div className="capitalize flex flex-col shadow-[0px_0px_10px_0px_#0000001A]  gap-4  p-6 md:px-[42px] md:py-8 ">
      <div className="flex justify-between border-b pb-2 border-primaryBlue-border w-full">
        ...
        <div>
          <select
            className={`appearance-none bg-no-repeat bg-right bg-[url(assets/icons/chevron-down.svg)] border-2  text-xl-regular text-neutral-900 w-[108px] flex flex-row items-center gap-11 text-xl-regular bg-primaryBlue-surface border-primaryBlue-border rounded-[4px] py-1 px-2`}
          >
