         ...
         return (
            <div className="flex flex-col gap-[24px]">
                ...
                <div className="flex justify-between items-center border-b pb-2 border-primaryBlue-border w-full">
                    ...
                    <select className={`appearance-none bg-no-repeat bg-right bg-[url(assets/icons/chevron-down.svg)]  border-2  text-xl-regular text-neutral-900 md:w-[160px] w-[108px] flex flex-row items-center gap-11 text-xl-regular bg-white border-primaryBlue-border rounded-[4px] p-[4px_8px_4px_8px] md:p-[8px_16px_8px_16px]`}>
