...
export default function JobApplication() {
  return (
    ...
    <section className="p-4 md:p-8 md:mx-auto">
        ...
        <div className="flex gap-4 w-full lg:flex-row lg:flex-wrap lg:justify-center lg:flex lg:gap-6 md:mx-auto md:w-fit flex-col md:grid md:grid-cols-2 md:mt-5 md:gap-6">
