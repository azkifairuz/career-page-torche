...
function Login() {
    ...
    return(
        <div class="flex flex-col items-center justify-center px-6 md:w-[400px] lg:w-[500px]  py-8 mx-auto md:h-screen lg:py-0">
            <h1 href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900">
                Login 
            </h1>
            <div class="w-full  rounded-lg shadow shadow-slate-400  md:mt-0 sm:max-w-md xl:p-0 bg-primary-500 border-gray-700">
